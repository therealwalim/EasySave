...
namespace CryptoSoft
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (verifyArgs(args)) // If Arguments are valid
            {
                ...
                try
                {
                    ...
                    stopwatch.Stop();
                    Console.WriteLine("Done ! Time elapsed: " + stopwatch.ElapsedMilliseconds + " ms.");
                    Console.WriteLine("");
        ...
        // Encrypt using XOR
        public static void Encrypt(string sourcePath, string destinationPath, string mode, int key)
        {
        ...
        public static string XORProvider(string inputText, int key)
        {
